...
namespace Chievfx.Mcp.Editor
{
    internal sealed class AssetToolService : IChievfxMcpToolHandler
    {
        ...
        public AssetToolService(Func<JToken, object> refresh, Func<JToken, object> delete, Func<JToken, object> create, Func<JToken, object> ensureFolder, Func<JToken, object> recompile)
        {
